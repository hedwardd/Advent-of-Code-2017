lines = """oaoe rxeq vssdqtu xrk cjv yaoqp loo
...
## initiate # of invalid phrases
invalids = 0

## split input into lines/phrases
...
for phrase in lines:
	...
	## for every word in phrase (reset word counter)
	for word in phrase:
		wordcount = 0

		##compare to all words in the phrase
		for word2 in phrase:
			if word2 == word:
				wordcount += 1

		##if there were repeats, the phrase is invalid
		##count it and move to next phrase
		if wordcount > 1:
			invalids +=1
			break

## print # of total phrases - invalid phrases
